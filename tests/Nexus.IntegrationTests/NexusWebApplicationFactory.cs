...
{
    private readonly PostgreSqlContainer _postgres = new PostgreSqlContainerBuilder()
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            {
                ["ConnectionStrings:Nexus"] = _postgres.GetConnectionString()
            });
        });
...
public class PostgresCollection : ICollectionFixture<NexusWebApplicationFactory> { }
